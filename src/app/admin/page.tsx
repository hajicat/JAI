          ...
          {[
            ...
            <button key={t.key} onClick={() => setTab(t.key as any)}
              className={`px-5 py-2.5 rounded-xl text-sm font-medium transition ${
                tab === t.key ? 'bg-gradient-to-r from-pink-500 to-stone-500 text-white shadow-lg' : 'bg-white/60 text-gray-500 hover:bg-white'
              }`}>
                      ...
                      <Fragment key={p}>
                        ...
                        <button
                          ...
                          className={`w-8 h-7 text-xs font-medium rounded-lg transition ${
                            p === currentPage
                              ? 'bg-gradient-to-r from-pink-500 to-stone-500 text-white shadow'
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <button onClick={generateCodes} disabled={generating}
                className="px-5 py-2 text-sm font-medium text-white bg-gradient-to-r from-pink-500 to-stone-500 rounded-xl hover:opacity-90 transition">
            ...
            <div className="glass-card rounded-3xl p-10 text-center">
              ...
              <div className="flex items-center justify-center gap-3">
                <button onClick={runMatching} disabled={generating}
                  className="px-10 py-4 text-lg font-semibold text-white bg-gradient-to-r from-pink-500 to-stone-500 rounded-full hover:opacity-90 disabled:opacity-50 transition shadow-lg">
                  {generating ? '匹配中...' : '🎁 开始匹配'}
                </button>
                {/* 始终可见的历史记录入口 */}
                {!matchDetailVerified ? (
            ...
            <div className="glass-card rounded-2xl p-6 mt-6">
              ...
              <div className="space-y-3 max-w-md">
                ...
                <button onClick={handleChangePassword}
                  ...
                  className="px-5 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-pink-500 to-stone-500 rounded-xl hover:opacity-90 disabled:opacity-50 transition">
          ...
          <div className="glass-card rounded-2xl p-8 w-full max-w-sm shadow-2xl animate-modal-in" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex gap-3 mt-5">
              ...
              <button onClick={handleVerifyPassword} disabled={verifyingPw || !verifyPassword.trim()}
                className={`flex-1 px-4 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-pink-500 to-stone-500 rounded-xl hover:opacity-90 transition ${
          ...
          <div className="glass-card rounded-2xl p-8 w-full max-w-sm shadow-2xl animate-modal-in" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex gap-3 mt-5">
              ...
              <button onClick={handleConfirmDelete} disabled={deletingConfirmed || !deletePw.trim()}
                className={`flex-1 px-4 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-red-500 to-stone-500 rounded-xl hover:opacity-90 transition ${
