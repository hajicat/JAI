    ...
    <div>
      ...
      {(() => {
        ...
        const faqs = [
          ...
          { q: '验证码发送成功，但邮箱为什么收不到验证码？', a: '可能填错了邮箱地址，或者填的不是校园邮箱。请检查邮箱地址是否正确，确保使用的是学校分配的校内邮箱。如果确认邮箱无误但仍收不到，可能需要联系学校邮箱管理员确认功能是否正常。目前系统邮件发送成功率约为91%。' },
          { q: '用学生账号密码登陆，会不会拿走另作他用？', a: '绝对不会。我们只在你首次注册时用学校邮箱发一次验证码来确认你是该校学生，之后不会再访问你的学校邮箱。' },
        ]
        return (
