...
function LoginForm() {
        ...
        try {
          ...
          if (data.withinRange) {
            ...
            if (data.requiresSchoolEmail) {
              setEmailHint('💡 该区域需使用校内邮箱注册（@jlu.edu.cn / @mails.jlu.edu.cn / @mails.cust.edu.cn / @stu.ccut.edu.cn / @jlju.edu.cn / @nenu.edu.cn / @jisu.edu.cn / @mails.ccu.edu.cn / @ccucm.edu.cn）')
            }
  ...
  const handleSendCode = async () => {
    ...
    if (requiresSchoolEmail) {
      ...
      const allowedDomains = ['jlu.edu.cn', 'mails.jlu.edu.cn', 'mails.cust.edu.cn', 'stu.ccut.edu.cn', 'jlju.edu.cn', 'nenu.edu.cn', 'jisu.edu.cn', 'mails.ccu.edu.cn', 'ccucm.edu.cn']
      if (!allowedDomains.includes(domain)) {
        setError('该区域必须使用校内邮箱注册（@jlu.edu.cn / @mails.jlu.edu.cn / @mails.cust.edu.cn / @stu.ccut.edu.cn / @jlju.edu.cn / @nenu.edu.cn / @jisu.edu.cn / @mails.ccu.edu.cn / @ccucm.edu.cn）')
        return
      }
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {isRegister && (
              <div className="bg-gray-50 rounded-xl p-4 space-y-3">
                ...
                <p className="text-xs text-stone-500 mt-0.5">如果垃圾箱也没有，请发送邮件到网站下方的邮箱，半小时内解决</p>
                <input
                  type="text"
                  inputMode="numeric"
                  pattern="[0-9]*"
