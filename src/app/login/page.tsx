...
function LoginForm() {
  ...
  const handleSendCode = async () => {
    ...
    if (requiresSchoolEmail) {
      ...
      const allowedDomains = ['jlu.edu.cn', 'mails.jlu.edu.cn', 'mails.cust.edu.cn', 'stu.ccut.edu.cn', 'jlju.edu.cn', 'nenu.edu.cn', 'jisu.edu.cn']
      if (!allowedDomains.includes(domain)) {
        setError('该区域必须使用校内邮箱注册（@jlu.edu.cn / @mails.jlu.edu.cn / @mails.cust.edu.cn / @stu.ccut.edu.cn / @jlju.edu.cn / @nenu.edu.cn / @jisu.edu.cn）')
        return
      }
    }
