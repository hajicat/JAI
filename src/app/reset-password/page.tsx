    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 flex items-center justify-center px-4">
        <div className="glass-card rounded-3xl p-8 shadow-xl text-center max-w-md w-full">
          ...
          <Link href="/login"
            className="inline-block w-full py-3 text-white font-semibold bg-gradient-to-r from-pink-500 to-purple-500 rounded-xl hover:opacity-90 transition text-center">
            返回登录页
          </Link>
        </div>
      </div>
